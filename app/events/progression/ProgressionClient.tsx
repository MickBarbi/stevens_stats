...
// Recharts is the biggest chunk of this page's JS and doesn't tree-shake
// well — load it only once the headline delta/table have already rendered.
const ProgressionChart = dynamic(() => import("./ProgressionChart"), {
  loading: () => <div className="h-[280px] animate-pulse rounded-card bg-surface" />,
});
